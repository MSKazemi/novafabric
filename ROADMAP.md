...
| **W9 — Multi-modal/tool-schema + standard interop + human-agent** | C7 C2PA/tool-schema (0148) · C8 A2A/AGNTCY/OCI/SCITT interop (0149) · C9 human-agent accountability (0150) | NF-161–190 | **partly experimental** — C7 ships 8 of 10 (`nova provenance`, `nova toolschema`, `nova diff --media`; NF-166/167 computer-use capture still future design) · C8 ships NF-171/172 (`nova a2a-card`, `nova a2a-objects`) · C9 future design. **ADRs accepted** (2026-07-15, /mska-approve) |
